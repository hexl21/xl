...
<%--							<div>欢迎您使用产业集群竞争力评价系统</div>--%>
<%--						</div>--%>
<%--					</div>--%>
						<div region="center" border="false"  style="width:100%;height: 100%">
							<div id="pp" style="position:relative">
								<div style="width:48%;">
									<div id="pgrid" title="test" collapsible="true" closable="true"  style="height:350px;">
										<div class="light-info">
											<div class="light-tip icon-tip"></div>
											<div>欢迎您使用本系统</div>
										</div>
								...
								<div style="width:48%;" >
									<div id="pgrid-1" title="test2" collapsible="true" closable="true"  style="height:350px;">
		...
		<div data-options="region:'south',border:false" style="height: 30px; overflow: hidden;text-align: center;background-color: #daeef5" >版权所有</div>
	</div>
