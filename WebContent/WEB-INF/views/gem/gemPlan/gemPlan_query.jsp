...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		...
		<a onclick="exportDatas();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon_excel'">导出</a>
		
		<a onclick="openFileFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon_attach'">附件</a>
