	...
	$(function() {
		...
		treeGrid = $('#treeGrid').treegrid({
			...
			onContextMenu: function(e, node){  
                        e.preventDefault();  
                        //$('#treeGrid').tree('select', node.target);  
                        $('#mm').menu('show', {  
                            left: e.pageX,  
                            top: e.pageY  
                        });  
...
<body>
	...
	<div id="mm" class="easyui-menu" style="width: 120px;">
        <div onclick="append()" iconcls="icon_add">
            添加节点</div>
        <div onclick="remove()" iconcls="edit_remove">
            删除节点</div>
        
        <div onclick="update()" iconcls="icon_edit">修改节点</div>
    </div>
</body>
</html>