		...
		var checked = $('#dataGrid').datagrid('getChecked');
			if(checked[0]!=null){
				...
				if(length>1){
					//$.messager.show({
		    		//	title:'提示',
		    		//	msg:'<div class="light-info"><div class="light-tip icon-tip"></div><div>只能选择一条记录</div></div>',
		    		//	showType:'show'
		    		//});
				...
				//$.messager.show({
		    	//		title:'提示',
		    	//		msg:'<div class="light-info"><div class="light-tip icon-tip"></div><div>请选择一条记录</div></div>',
		    	//		showType:'show'
		    	//	});
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div data-options="region:'west',border:false,split:true" title="字典类别" style="width:200px;overflow: hidden; ">
		<ul id="dictionarytypeTree" style="width:180px;margin: 10px 10px 10px 10px"></ul>
	</div>
	<div id="toolbar" style="display: none;">
		<c:if test="${fn:contains(sessionInfo.resourceList, '/user/add')}">
			<a onclick="addFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon_add'">添加</a>
			<a onclick="editFun2();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon_edit'">编辑</a>
		</c:if>
	</div>
</body>
</html>