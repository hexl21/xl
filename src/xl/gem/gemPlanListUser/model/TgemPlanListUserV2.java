...
@Entity
@Table(name = "gem_plan_list_user_v2", schema = "")
@DynamicInsert(true)
@DynamicUpdate(true)
public class TgemPlanListUserV2 extends IdEntityOralceUUID implements
	...
	public TgemPlanListUserV2() {
		super();
	}

	public TgemPlanListUserV2(String gemModelBomId, String gemModelBomName,
